...
<?php
 ...
 mysql_select_db('sanjay') or die(mysql_error());
   ...
   $var1=mysql_query("SELECT  * FROM recieve;");
   if($opening_balance == null)
   {
     while ($arr1=mysql_fetch_row($var1))
      {  
        if(($arr1[2] == $material_name) && ($arr1[3] == $unit))
        {
          $opening_balance = $arr1[4];
        }
      }
    }
 ...
 echo "ISSUE MATERIAL INFORMATION STORED SUCCESSFULLY";
?>
<p>
